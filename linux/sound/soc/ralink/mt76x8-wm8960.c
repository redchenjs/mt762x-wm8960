...
static const struct snd_soc_dapm_widget mt76x8_wm8960_widgets[] = {
...
static struct snd_soc_dai_link mt76x8_wm8960_dai_link = {
    .name = "wm8960-codec",
...
static struct snd_soc_card mt76x8_wm8960_card = {
    ...
    .owner = THIS_MODULE,
    .dai_link = &mt76x8_wm8960_dai_link,
    .num_links = 1,
    .dapm_widgets = mt76x8_wm8960_widgets,
    .num_dapm_widgets = ARRAY_SIZE(mt76x8_wm8960_widgets),
};
...
static int mt76x8_wm8960_machine_probe(struct platform_device *pdev)
{
    ...
    mt76x8_wm8960_dai_link.platform_of_node = platform_node;
    mt76x8_wm8960_dai_link.cpu_dai_name = dev_name(&i2s_pdev->dev);
    ...
    mt76x8_wm8960_dai_link.codec_of_node = codec_node;
